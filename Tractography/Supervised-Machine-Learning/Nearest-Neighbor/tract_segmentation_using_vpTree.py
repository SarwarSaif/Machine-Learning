...
def kdtree_query(tract,vp_tree):
    """compute 1 NN using kdtree query and return the id of NN
    """
         
    d, ind_kdtree = vp_tree.get_nearest_neighbor(tract)
    #Returns distances which is not useful
...
def segmentation_with_NN(filename_tractogram, filename_example_tract,tractList,no_of_points,leafsize):
    ...
    #Returns Distance which is not useful
...
if __name__ == '__main__':
    ...
    subjectList =[ "124422","161731","100408","100307"]
